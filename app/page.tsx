...
const tcgMatchers = [
  { name: 'Magic: The Gathering', shortName: 'MTG', style: 'mtg', match: /magic|gathering|the hobbit|modern horizons|wilds of eldraine|mh[23]|woe|bro/i },
  { name: 'Pokémon', shortName: 'Pokémon', style: 'pokemon', match: /pokemon|pokémon|sv\d|swsh|scarlet|violet/i },
  { name: 'One Piece Card Game', shortName: 'One Piece', style: 'one-piece', match: /one piece|op\d|eb\d|starter deck/i },
  { name: 'Yu-Gi-Oh!', shortName: 'Yu-Gi-Oh!', style: 'yugioh', match: /yu-gi-oh|yugioh|speed duel|legend of blue eyes/i },
  { name: 'Disney Lorcana', shortName: 'Lorcana', style: 'lorcana', match: /lorcana|the first chapter|inklands/i },
]
