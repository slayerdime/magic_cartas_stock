...
export default function Home() {
  ...
  return <main className={dark ? 'site dark' : 'site'}>
    ...
    <footer id="community" className="footer wrap"><a className="brand" href="#top"><span className="brand-mark"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-09-18%20at%2015.01.31-40ZBvu0IWMXWBocEzVy2gjkybyE1sN.jpeg" alt="Oasis TCG" /></span>cardvault</a><p>Para quienes coleccionan con intención.</p><div className="footer-links"><a href="#collection">Colección</a><a href="#insights">Análisis</a><a href="#">Instagram</a></div></footer>
  </main>
}
