...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    const result = mode === 'login'
      ...
      : await supabase.auth.signUp({ email, password, options: { emailRedirectTo: redirectTo, data: { state } } })
